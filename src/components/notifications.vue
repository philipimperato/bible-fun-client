    ...
    >
      ...
      >
        <div class="flex w-full flex-col items-center space-y-4 sm:items-end">
          <transition
            enter-active-class="transform ease-out duration-300 transition" enter-from-class="translate-y-2 opacity-0 sm:translate-y-0 sm:translate-x-2" enter-to-class="translate-y-0 opacity-100 sm:translate-x-0" leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100"
                ...
                <div class="flex items-start">
                  <div class="flex-shrink-0">
                    <bx:error-circle
                      ...
                      class="h-6 w-6 text-red-500" aria-hidden="true"
                    />
                    <iconoir:twitter-verified-badge
                      v-if="notification.type === 'success'"
                      class="h-6 w-6 text-green-500" aria-hidden="true"
                    />
                  </div>
